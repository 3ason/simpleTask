...
/* 
Section on Why I do the things I do and how should I give meaning to tasks that mean a lot to me, but I forget.
I don't know, I feel like I default to not laziness but just escapism and that's something I have to fix. 
    1. One thing I can fix first is maybe not be ashamed of myself. 
    2. How do I start doing that? I'm not sure, probably by working out consistently again. 
        3. Things move fast but also slow.
        4. Parasyte OST Next to You is one of my favorite 
    5. Back to why I'm doing this deliverable/task_manager
        * I want to keep track of things and remember their significance. 
            I suppose significance can come in a multitude of ways right. 
    6. 
*/
...
*/
    ...
    while(1+2==3) {
        ...
        if(user_Input == 'q'){
            ...
            cin.clear();
            cout << "Constructing New Task...";
            cout << "How do I assign IDs? Insert ID" << endl; //i think just let the user decide for now 
            //just check that there is no repeat on id
            int idNumber;
            cin >> idNumber;
            for(auto & task : taskList) {
                ...
                if(task.getID() == idNumber){
                    ...
                    break;
                    log = "Error, id Number already Taken, please try a new one";
                }else {
                    cout << "Enter String Description" << endl;
                    string tempDescription;
                    cin >> tempDescription;
	    	    cout << "Enter Date Description(Format:MM/DD/YY)" << endl
		    string tempDate; 
		    cin.clear();
		    cin >> tempDate;
...
//have task be reminded as it approaches a specific date


/*
Cool Tool for Stucking the Program to check values or process
   while(1){
                cin.clear();
                cin >> t;
                if(t == 'p'){
